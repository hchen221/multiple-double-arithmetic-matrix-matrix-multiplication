//adapted from quad_double_functions.cpp in PHCpack
...
__host__ __device__ void qdf_renorm4
...
__host__ __device__ void qdf_fast_renorm
...
__host__ __device__ void qdf_renorm_add1
...
__host__ __device__ void qdf_copy
...
__host__ __device__ void qdf_abs
 ( double a_hihi, double a_lohi, double a_hilo, double a_lolo,
   double *b_hihi, double *b_lohi, double *b_hilo, double *b_lolo )
{
   if(a_hihi < 0.0)
...
__host__ __device__ void qdf_add
 ( double a_hihi, double a_lohi, double a_hilo, double a_lolo,
   double b_hihi, double b_lohi, double b_hilo, double b_lolo,
...
__host__ __device__ void qdf_inc
 ( double *a_hihi, double *a_lohi, double *a_hilo, double *a_lolo,
   double b_hihi, double b_lohi, double b_hilo, double b_lolo )
{
   double f0,f1,f2,f3,f4,e;
...
__host__ __device__ void qdf_inc_d
 ( double *a_hihi, double *a_lohi, double *a_hilo, double *a_lolo,
   double b )
{
...
__host__ __device__ void qdf_dec
 ( double *a_hihi, double *a_lohi, double *a_hilo, double *a_lolo,
   double b_hihi, double b_lohi, double b_hilo, double b_lolo )
{
...
__host__ __device__ void qdf_minus
 ( double *a_hihi, double *a_lohi, double *a_hilo, double *a_lolo )
{
   *a_hihi = -(*a_hihi);
   *a_lohi = -(*a_lohi);
...
__host__ __device__ void qdf_sub
 ( double a_hihi, double a_lohi, double a_hilo, double a_lolo,
   double b_hihi, double b_lohi, double b_hilo, double b_lolo,
   double *c_hihi, double *c_lohi, double *c_hilo, double *c_lolo )
{
...
__host__ __device__ void qdf_mul_pwr2
...
__host__ __device__ void qdf_mul
 ( double a_hihi, double a_lohi, double a_hilo, double a_lolo,
   double b_hihi, double b_lohi, double b_hilo, double b_lolo,
   double *c_hihi, double *c_lohi, double *c_hilo, double *c_lolo )
{
...
__host__ __device__ void qdf_sqr
 ( double a_hihi, double a_lohi, double a_hilo, double a_lolo,
   double *c_hihi, double *c_lohi, double *c_hilo, double *c_lolo )
{
   double f0,f1,f2,f3,f4,p,e;
...
__host__ __device__ void qdf_mul_qd_d
 ( double a_hihi, double a_lohi, double a_hilo, double a_lolo,
   double b,
   double *c_hihi, double *c_lohi, double *c_hilo, double *c_lolo )
{
...
__host__ __device__ void qdf_mlt_d
 ( double *a_hihi, double *a_lohi, double *a_hilo, double *a_lolo,
   double b )
{
...
__host__ __device__ void qdf_div
 ( double a_hihi, double a_lohi, double a_hilo, double a_lolo,
   double b_hihi, double b_lohi, double b_hilo, double b_lolo,
   double *c_hihi, double *c_lohi, double *c_hilo, double *c_lolo )
{
...
__host__ __device__ void qdf_sqrt
 ( double a_hihi, double a_lohi, double a_hilo, double a_lolo,
   double *b_hihi, double *b_lohi, double *b_hilo, double *b_lolo )
{
